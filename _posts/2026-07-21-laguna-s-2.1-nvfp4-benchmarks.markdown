...
*Score estimated from pass/partial/fail counts. Sub-scores A-E were truncated in the OCR output.
...
|---|---|---|---|
| **BugFind** | 88.8 | 90 | Qwen3.6 |
| **InstrucFollow** | 84.0 | 97 | Qwen3.6 |
| **DataExtract** | 86.8 | 85 | Laguna |
| **HermesAgent** | ~70 | 62 | Laguna |
